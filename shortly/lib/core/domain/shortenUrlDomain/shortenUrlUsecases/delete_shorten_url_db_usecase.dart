...
class DeleteShortenUrlDBUsecase implements BaseUseCase<String, Result<ErrorEntity, List<ShortenUrlEntity>>> {
  ShortenUrlRepository _repository;

  DeleteShortenUrlDBUsecase(this._repository);
  @override
  Future<Result<ErrorEntity, List<ShortenUrlEntity>>> call(String? input) async {
